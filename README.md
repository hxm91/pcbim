...
view the example gelabeled point cloud in range image form, approach 1. Because the points do not distributed around one circle, so that normal range image dosn't suit this case.
